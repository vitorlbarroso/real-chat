                    ...
                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg flex" style="min-height: 400px; max-height: 400px;">
                            ...
                            <div class="w-4/12 bg-gray-200 bg-opacity-30 border-r border-gray-150 overflow-y-scroll">
                                <ul>
                                    <li class="p-6 text-lg text-gray-600 leading-7 font-semibold border-b border-gray-200 hover:bg-gray-300 hover:bg-opacity-50 hover:cursor-pointer">
                                ...
                                <div class="w-full bg-gray-200 bg-opacity-25 p-6 border-t border-gray-200">
                                    <form>
                                        <div class="flex rounded-md overflow-hidden border border-gray-100">
                                            <input type="text" class="flex-1 px-4 py-2 text-sm border-transparent focus:border-transparent focus:ring-0">
